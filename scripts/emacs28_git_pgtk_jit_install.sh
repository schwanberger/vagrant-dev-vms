...
compile_install_emacs-git () {
    ...
    #Resetting `SECONDS` counter in this subshell
    SECONDS=0
    echo "Compiling and installing emacs-git (from branch feature/pgtk and JIT-feature)..."

    yay -G emacs-git; cd emacs-git; cp /home/vagrant/emacs28_git_pgtk_jit_PKGBUILD PKGBUILD; makepkg --syncdeps --install --noconfirm --needed --clean \
        1>/dev/null
